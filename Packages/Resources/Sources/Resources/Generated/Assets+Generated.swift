...
public extension UIColor {
    ...
    static let greenShade1 = UIColor(named: "green_shade_1", in: .module, compatibleWith: .current)!
    static let greenShade2 = UIColor(named: "green_shade_2", in: .module, compatibleWith: .current)!
    static let greenShade3 = UIColor(named: "green_shade_3", in: .module, compatibleWith: .current)!
    static let greenShade4 = UIColor(named: "green_shade_4", in: .module, compatibleWith: .current)!
    static let orangeShade1 = UIColor(named: "orange_shade_1", in: .module, compatibleWith: .current)!
    static let orangeShade2 = UIColor(named: "orange_shade_2", in: .module, compatibleWith: .current)!
    static let orangeShade3 = UIColor(named: "orange_shade_3", in: .module, compatibleWith: .current)!
    static let orangeShade4 = UIColor(named: "orange_shade_4", in: .module, compatibleWith: .current)!
    static let purpleShade1 = UIColor(named: "purple_shade_1", in: .module, compatibleWith: .current)!
    static let purpleShade2 = UIColor(named: "purple_shade_2", in: .module, compatibleWith: .current)!
    static let purpleShade3 = UIColor(named: "purple_shade_3", in: .module, compatibleWith: .current)!
    static let purpleShade4 = UIColor(named: "purple_shade_4", in: .module, compatibleWith: .current)!
    static let redShade1 = UIColor(named: "red_shade_1", in: .module, compatibleWith: .current)!
...
public extension Image {
  // Colors.xcassets
  // Images.xcassets
  static var camusMap : Image { Image("camus_map", bundle: .module) }
...
public extension UIImage {
    static let camusMap = UIImage(named: "camus_map", in: .module, with: nil)!
