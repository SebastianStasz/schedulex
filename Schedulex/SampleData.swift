...
extension Event {
    static let sample = Event(facultyGroupName: "ZIIAS1-1113", facultyGroupColor: .blue, isEventTransfer: false, eventTransferNote: nil, startDate: .now, endDate: .now, name: "Probability and Statistics", place: "Paw.A 117 lab. Win10, Office21", teacher: "prof. UEK dr hab. Grażyna Paliwoda-Pękosz", teacherProfileUrl: URL(string: "https://e-uczelnia.uek.krakow.pl/course/view.php?id=443#section-0")!, teamsUrl: nil, type: "wykład do wyboru")
    static let eventTransfer = Event(facultyGroupName: "ZIIAS1-1113", facultyGroupColor: .blue, isEventTransfer: true, eventTransferNote: "na 17.01.2024", startDate: .now, endDate: .now, name: "Probability and Statistics", place: "Place", teacher: "dr Some Name", teacherProfileUrl: URL(string: "https://e-uczelnia.uek.krakow.pl/course/view.php?id=443#section-0")!, teamsUrl: nil, type: "Przeniesienie zajęć")
}
